...
if (os.path.isfile('questions.txt') == True):
    ...
    questions=[['is it hot today ?','easy'],['what is Tkinter?','easy'],["what's 1+2 ?",'med'], ['what is POO ?','hard']]
print("before: \n",questions)
print(len(questions))
#     -------------------------------------------*-----------------------------------------------
if (os.path.isfile('answer_choice.txt') == True):
    ...
    answer_choice=[["cold","normal","hot","very hot",],
                ...
                ["4","3","1","0",],
                ["Object oriented programming ","Proclamation Orienté Octé","Paralilisme Othorodental Olphactive","Prolongation Octa Oreal",],]
...
def startQuiz():
    ...
    lblQuestion=Label(root,text=questions[indexes[0]],font=("arial",15,"bold"),width=500,justify="center",wraplength=400,background="#1e7fc2")
...
lblRules=Label(root,text="Each Question you answer correctly gives you 5 points ! \n You have 30s to finish the quiz."
                         ,width=100,font=("Times",14),background="#000000",foreground="#FACA2F")
lblRules.pack()
btn4=Button(root, text="Exit",font=("arial",10), width=20, height=2, bg="#87409f",activebackground="#FF0000",command=root.destroy)
btn4.place(x=260,y=550)
btn3=Button(root, text="ADMIN SIDE ",font=("arial",10), width=20, height=2, bg="#f7c053",activebackground="#eed344",command=to_adminside)
